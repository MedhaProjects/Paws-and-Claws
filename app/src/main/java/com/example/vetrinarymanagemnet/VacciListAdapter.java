...
public class VacciListAdapter extends ArrayAdapter<Vacci> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        viewOnMapButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Uri gmmIntentUri = Uri.parse("google.navigation:q=" + vacci.getLatitude() + "," +vacci.getLongitude());
                ...
                if (mapIntent.resolveActivity(getContext().getPackageManager()) != null) {
                    ...
                    Uri mapWebUri = Uri.parse("https://www.google.com/maps/dir/?api=1&destination="
                            + vacci.getLatitude() + "," + vacci.getLongitude());
    ...
    // RecyclerView Adapter ViewHolder for Booking list
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindData(Booking booking) {
            petNameTextView.setText(booking.getPetName());
        }
    }
