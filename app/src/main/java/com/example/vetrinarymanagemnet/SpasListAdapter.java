...
public class SpasListAdapter extends ArrayAdapter<Spa> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (spa != null) {
            ...
            Log.d("SpasListAdapter", "Spa Coordinates: " + spa.getLatitude() + ", " + spa.getLongitude());
        ...
        viewOnMapButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Uri gmmIntentUri = Uri.parse("google.navigation:q=" + spa.getLatitude() + "," + spa.getLongitude());
                ...
                if (mapIntent.resolveActivity(getContext().getPackageManager()) != null) {
                    ...
                    Uri mapWebUri = Uri.parse("https://www.google.com/maps/dir/?api=1&destination="
                            + spa.getLatitude() + "," + spa.getLongitude());
